...
namespace LawyerServices.Web.Areas.Identity.Pages.Account.Manage
{
    public class LawyerAreaOfActivitiesModel : PageModel
    {
        ...
        [BindProperty]
        public AreasOfActivityInputModel AreaModel { get; set; }
        ...
        public LawyerAreaOfActivitiesModel(IEnumerable<AreasOfActivityViewModel> areasOfActivitys, IAreasOfActivityService areasOfActivityService, UserManager<ApplicationUser> userManager)
        {
            this.AreasOfActivitys = areasOfActivitys;
        ...
        [Authorize(Roles = GlobalConstants.LawyerRoleName)]
        public IActionResult OnPost(AreasOfActivityInputModel AreaModel)
        {
            
            var user = this.userManager.GetUserAsync(this.User).Result;
            var companyId = user.CompanyId;
            var userId = this.userManager.GetUserId(this.User);
            this.areasOfActivityService.CreateArea(companyId, AreaModel);
